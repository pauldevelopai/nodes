...
(function () {
  ...
  css.id = 'gc-style';
  css.textContent = [
    "#gc-nav{display:block;border-bottom:1px solid #E2E8F0;background:#fff;font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;position:sticky;top:0;z-index:9000}",
    ...
    '#gc-nav .gc-links>a,#gc-nav .gc-dd>button{padding:8px 12px;border-radius:6px;font:500 14px inherit;color:#718096;text-decoration:none;background:transparent;border:none;cursor:pointer;display:flex;align-items:center;gap:4px}',
    ...
    '#gc-nav .gc-menu a{padding:8px 12px;font:500 14px inherit;color:#1A202C;text-decoration:none;border-radius:6px;white-space:nowrap}',
    ...
    '#gc-nav .gc-btn{font:500 13px inherit;color:#718096;background:none;border:1px solid #E2E8F0;border-radius:6px;padding:7px 12px;cursor:pointer;text-decoration:none}',
    ...
    '.gc-send{padding:7px 16px;background:' + TERRACOTTA + ';color:#fff;border:none;border-radius:6px;font:600 13px inherit;cursor:pointer}',
